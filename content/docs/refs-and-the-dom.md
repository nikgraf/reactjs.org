...
> Note
>
> In this examples a new Ref is created on every render. For function components we recommend using [useRef](/docs/hooks-reference.html#useref) for instead since it returns the same ref across multiple renders.
